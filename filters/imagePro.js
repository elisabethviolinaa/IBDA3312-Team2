...
// Set the clear color for clearing the color buffer
gl.clearColor(0.0, 0.0, 0.0, 1.0);
// Clear the color and depth buffers
gl.clear(gl.COLOR_BUFFER_BIT|gl.DEPTH_BUFFER_BIT);

// Define kernel for edge enhancement
var kernels = {
...
colorImage.src = '../assets/cool_palette.jpg';
...
// Function to set frame buffer texture
const setFBTex = () => {
    gl.activeTexture(gl.TEXTURE0 + 0);
...
const applyImgPrc = (filter) => {
    ...
    // Tells WebGL to render to the attached renderbuffer instead of the default framebuffer (the canvas)
